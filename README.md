...
Цель проекта - решить задачу классификации с учителем с использованием алгоритма KNN на примере учебного датасета (Ирисы) и оценить его производительность.
...
Сравнение матриц мутаницы:

<img src="./images/confusionMatrix.png" height="400">
<img src="./images/LogisticRegressionConfusion.png" height="400">
<img src="./images/RandomForestConfusion.png" height="400">

Отсюда видно, что как при регрессии, так и при дереве присутствует асимметричная ошибка в определении классов *virginica* и *versicolor*. Если модель KNN ошибалась одинаково, то остальные модели чаще выбирают класс *versicolor*. Это еще раз подтвержает гипотезу о том, что классы имеют близкие признаки. Асимметрия возникает вследствие смещения границы принятия решения. При дальнейшем масштабировании модели это может привести к поглощению одного класса другим.
